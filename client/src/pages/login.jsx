  ...
  return (
    ...
    >
      ...
      <div className="text-end mb-4">
        <a
          href="#"
          className="text-[#005587] uppercase text-sm font-[500]"
        >
          Forget User ID?
        </a>
      </div>
      ...
      >
        <span
          className="absolute top-3 right-2 font-semibold text-sm cursor-pointer text-[#005587]"
      ...
      <div className="flex mt-3 gap-4 items-center justify-end">
        <label
          htmlFor="checkbox"
          className="text-[#005587] text-lg"
        >
          Remember me
        </label>
        <input
      ...
      <div className="flex items-center justify-between gap-2 px-3 md:px-10">
        <Button
          style={{
